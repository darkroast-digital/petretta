...
if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] != true) {
    ...
    if ($level == "admin") {
        ...
        ?> <script type="text/javascript">function chkExtensions(formname, checktoggle) {
            ...
            });</script><div id="content-main"><h2>Edit User</h2><div class="clear"></div> <?php echo $msg; ?> <form action="" enctype="multipart/form-data" method="post" name="ff1" class="form-horizontal inner-form"><input value="yes" name="edit_user" type="hidden"> <input value="<?php echo $id; ?>" name="id" type="hidden"> <input value="<?php echo $accesslevel2; ?>" name="_accesslevel" type="hidden"><div class="form-group"><label for="username" class="col-sm-4 control-label">Username:</label><div class="col-sm-8"><input class="form-control user_id_adv" name="username" type="text" id="username" value="<?php echo $username ?>" placeholder="Username" <?php echo ($id != $_SESSION['idUser']) ? "" : "readonly" ?>></div></div> <?php if ($id != $_SESSION['idUser']) { ?> <div class="form-group"><label for="active" class="col-sm-4 control-label">Status:</label><div class="col-sm-8"><select name="active" id="active" class="form-control"><option value="">Please Select</option> <?php echo $user_stat; ?> </select></div></div> <?php }else{ ?> <input type="hidden" name="active" value="<?php echo($active)?>"> <?php } ?> <div class="form-group"><label for="password" class="col-sm-4 control-label">Password:</label><div class="col-sm-8"><input class="form-control password_adv" name="password" type="text" id="password" placeholder="Password"></div><span onclick="randomPassword();" class="updatePass">&nbsp&nbsp<img src="images/icon_refresh.png"></span></div> <?php if ($id != $_SESSION['idUser']) { ?> <div class="clear"></div><div class="form-group"><div class="col-sm-offset-4 col-sm-8"><div class="checkbox"><label><input type="checkbox" name="sendpass">Send password to user upon save</label></div></div></div> <?php } ?> <div class="clear"></div><div class="form-group"><label for="email" class="col-sm-4 control-label">Email:</label><div class="col-sm-8"><input class="form-control" name="email" type="email" id="email" placeholder="Email" value="<?php echo $email ?>"></div></div><div class="clear"></div><div class="form-group"><label for="email" class="col-sm-4 control-label">Permissions:</label><div class="col-sm-8"><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="t" <?php if (stristr($accesslevel2, "t")) {
                            echo "checked";
                        } ?>>Can view only own files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user will see only files uploaded by him/her"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="g" <?php if (stristr($accesslevel2, "g")) {
                            echo "checked";
                        } ?>> Can upload files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user will be able to upload files in assigned directories"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="i" <?php if (stristr($accesslevel2, "i")) {
                            echo "checked";
                        } ?>> Can view everyone's files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user will see all files in directories he/she is assigned to."></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="h" <?php if (stristr($accesslevel2, "h")) {
                            echo "checked";
                        } ?>> Can delete own files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user will be able to delete files which were uploaded by him/her"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="j" <?php if (stristr($accesslevel2, "j")) {
                            echo "checked";
                        } ?>> Can delete any file. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user will be able to delete any files in assigned directories"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="k" <?php if (stristr($accesslevel2, "k")) {
                            echo "checked";
                        } ?>> Can edit own files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user can rename own files"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="l" <?php if (stristr($accesslevel2, "l")) {
                            echo "checked";
                        } ?>> Can edit all files. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, user can rename any file in assigned directories"></label></div><div class="checkbox"><label><input type="checkbox" name="accesslevel2[]" value="m" <?php if (stristr($accesslevel2, "m")) {
                            echo "checked";
                        } ?>> Can share any file. <img src="images/info.png" height="18" width="18" class="tipTip" title="If selected, sharing files will be enabled for this user"></label></div></div></div><div class="form-group"><label for="email" class="col-sm-4 control-label">Extensions:<div class="subLabel"><a href="javascript:;" onclick="chkExtensions('ff1', true);">check all</a> | <a href="javascript:;" onclick="chkExtensions('ff1', false);">uncheck all</a></div></label><div class="col-sm-8"> <?php echo $extStr; ?> </div></div><div class="clear"></div><div class="form-group"><label for="quota" class="col-sm-4 control-label">Disk Size Quota:</label><div class="col-sm-3"><input class="form-control" name="quota" type="text" id="quota" placeholder="MB" value="<?php echo $quota ?>"></div><div class="icon-info">MB <img src="images/info.png" height="18" width="18" class="tipTip" title="Maximum allocated storage space for this user."></div></div><div class="clear"></div><div class="clear"></div><div class="form-group"><label for="quota" class="col-sm-4 control-label">Maximum File Size:</label><div class="col-sm-3"><input class="form-control" name="filesize" type="text" id="filesize" placeholder="MB" value="<?php echo $filesize ?>"></div><div class="icon-info">MB <img src="images/info.png" height="18" width="18" class="tipTip" title="Maximum file size per each file uploaded."></div></div><div class="clear"></div><div class="form-group folder"><label for="email" class="col-sm-4 control-label">Directories:<div class="subLabel"><a href="javascript:;" onclick="chkFolders( true);">check all</a> | <a href="javascript:;" onclick="chkFolders( false);">uncheck all</a></div></label><div class="col-sm-8"> <?php getFoldersCheckForUser($upload_dirs)?> </div></div><div class="clear"></div><div class="form-group inline-form"><div class="col-sm-offset-4 col-sm-3"><button type="submit" class="btn btn-primary btn-block">Submit</button></div> <?php if ($accesslevel2 != 'abcdefghijklmnopqrstuvwxyz') { ?> <div class="col-sm-offset-1 col-sm-4"><button class="btn btn-danger btn-block" name="admin" type="submit">Set As admin</button></div> <?php } ?> </div></form></div><div class="clear"></div> <?php include "includes/footer.php";
    }
} ?>