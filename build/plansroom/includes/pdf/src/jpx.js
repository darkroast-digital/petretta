...
var JpxImage = (function JpxImageClosure() {
    ...
    function copyCoefficients(coefficients, x0, y0, width, height, delta, mb, codeblocks, transformation, segmentationSymbolUsed) {
    ...
    var BitModel = (function BitModelClosure() {
        ...
        BitModel.prototype = {
            ...
            setNeighborsSignificance: function BitModel_setNeighborsSignificance(row, column) {
    ...
    var Transform = (function TransformClosure() {
        ...
        Transform.prototype.iterate = function Transform_iterate(ll, hl, lh, hh, u0, v0) {
