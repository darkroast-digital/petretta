...
*/
                'thumbnail' => array(// Uncomment the following to use a defined directory for the thumbnails
                    ...
                    'crop' => true, 'max_width' => 80, 'max_height' => 80)));
        if ($options) {
    ...
    {
        /*if ($demo) {
            $file->error = $this->get_error_message("demo");
            return false;
        }*/
        if ($error) {
    ...
    {
        return $this->get_unique_filename($file_path, $this->trim_file_name($file_path, $name, $size, $type, $error, $index, $content_range), $size, $type, $error, $index, $content_range);
    }
