 ...
 */
PDFJS.getDocument = function getDocument(source, pdfDataRangeTransport, passwordCallback) {
...
var PDFPageProxy = (function PDFPageProxyClosure() {
     ...
     * }.
         ...
         * For internal use only.
         */
        display: function PDFPageProxy_display(gfx, viewport, callback, continueCallback) {
            var stats = this.stats;
            ...
            var continueWrapper;
            if (continueCallback)
                continueWrapper = function () {
                    continueCallback(next);
                };
            else
...
var WorkerTransport = (function WorkerTransportClosure() {
    function WorkerTransport(workerInitializedPromise, workerReadyPromise, pdfDataRangeTransport) {
