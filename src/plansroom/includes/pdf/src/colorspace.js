...
var ColorSpace = (function ColorSpaceClosure() {
    ...
    ColorSpace.prototype = {
         ...
         */
        getRgbBuffer: function ColorSpace_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
         ...
         */
        createRgbBuffer: function ColorSpace_createRgbBuffer(src, srcOffset, count, bits) {
...
var AlternateCS = (function AlternateCSClosure() {
    ...
    AlternateCS.prototype = {
        ...
        getRgbBuffer: function AlternateCS_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
...
var IndexedCS = (function IndexedCSClosure() {
    ...
    IndexedCS.prototype = {
        ...
        getRgbBuffer: function IndexedCS_getRgbBuffer(src, srcOffset, count, dest, destOffset) {
            var base = this.base;
...
var DeviceGrayCS = (function DeviceGrayCSClosure() {
    ...
    DeviceGrayCS.prototype = {
        ...
        getRgbBuffer: function DeviceGrayCS_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
...
var DeviceRgbCS = (function DeviceRgbCSClosure() {
    ...
    DeviceRgbCS.prototype = {
        ...
        getRgbBuffer: function DeviceRgbCS_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
            var length = count * 3;
            if (bits == 8) {
...
var DeviceCmykCS = (function DeviceCmykCSClosure() {
    ...
    DeviceCmykCS.prototype = {
        ...
        getRgbBuffer: function DeviceCmykCS_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
            var scale = 1 / ((1 << bits) - 1);
            for (var i = 0; i < count; i++) {
...
var LabCS = (function LabCSClosure() {
    ...
    LabCS.prototype = {
        ...
        getRgbBuffer: function LabCS_getRgbBuffer(src, srcOffset, count, dest, destOffset, bits) {
            var maxVal = (1 << bits) - 1;
            for (var i = 0; i < count; i++) {
