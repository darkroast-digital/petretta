...
var PartialEvaluator = (function PartialEvaluatorClosure() {
    function PartialEvaluator(pdfManager, xref, handler, pageIndex, uniquePrefix, idCounters) {
    ...
    PartialEvaluator.prototype = {
        ...
        buildFormXObject: function PartialEvaluator_buildFormXObject(resources, xobj, smask) {
            var self = this;
        ...
        buildPaintImageXObject: function PartialEvaluator_buildPaintImageXObject(resources, image, inline) {
            var self = this;
            var dict = image.dict;
        ...
        handleTilingType: function PartialEvaluator_handleTilingType(fn, args, resources, pattern, patternDict) {
            var self = this;
        ...
        handleSetFont: function PartialEvaluator_handleSetFont(resources, fontArgs, font) {
            var promise = new Promise();
        ...
        insertDependencies: function PartialEvaluator_insertDependencies(queue, dependencies) {
        ...
        getOperatorList: function PartialEvaluator_getOperatorList(stream, resources) {
            var self = this;
            var xref = this.xref;
        ...
        readToUnicode: function PartialEvaluator_readToUnicode(toUnicode, xref, properties) {
            ...
            for (var i = 0, ii = fnArray.length; i < ii; i++) {
                if (fnArray[i] === 'paintInlineImageXObject' &&
                    ...
                    argsArray.splice(j, count * 4,
                        [
                            {width: imgWidth, height: imgHeight, data: imgData},
                            map
                        ]);
                    i = j;
                    ii = fnArray.length;
