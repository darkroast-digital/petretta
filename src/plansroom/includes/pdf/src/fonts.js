        ...
        checkAndRepair: function Font_checkAndRepair(name, font, properties) {
            ...
            function readCmapTable(cmap, font, hasEncoding, isSymbolicFont) {
                ...
                for (var i = 0; i < numTables; i++) {
                    ...
                    } else if (platformId === 1 && encodingId === 0 && !foundPreferredTable) {
                        useTable = true;
                        foundPreferredTable = true;
            ...
            function sanitizeGlyphLocations(loca, glyf, numGlyphs, isGlyphLocationsLong) {
...
Type1Font.prototype = {
    getOrderedCharStrings: function Type1Font_getOrderedCharStrings(glyphs, properties) {
        var charstrings = [];
        var usedUnicodes = [];
