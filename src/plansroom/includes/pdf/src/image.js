...
var PDFImage = (function PDFImageClosure() {
     ...
     */
    PDFImage.buildImage = function PDFImage_buildImage(callback, handler, xref, res, image, inline) {
     ...
     */
    PDFImage.resize = function PDFImage_resize(pixels, bpc, components, w1, h1, w2, h2) {
    ...
    PDFImage.prototype = {
        ...
        applyStencilMask: function PDFImage_applyStencilMask(buffer, inverseDecode) {
