        ...
        if(mysqli_query($mysqli,$query)){
          $tt .=  "Created table '{$db_pr}extensions' (3/8)<br/>";
            ...
            $query= "INSERT INTO `{$db_pr}extensions` (`dateCreated`, `name`) VALUES (NOW(),'AVI'), (NOW(),'BMP'), (NOW(),'BSH'), (NOW(),'C'), (NOW(),'CC'), (NOW(),'CPP'), (NOW(),'CS'),
             (NOW(),'CSH'), (NOW(),'CSS'), (NOW(),'CV'), (NOW(),'CYC'), (NOW(),'DOC'), (NOW(),'GIF'), (NOW(),'HTM'), (NOW(),'HTML'), (NOW(),'JAVA'), (NOW(),'JOSH'), (NOW(),'JPEG'), (NOW(),'JPG'), (NOW(),'JS'), (NOW(),'M'),
      ...
      //create users
         ...
         //create admin
            ...
            $query="INSERT INTO `{$db_pr}users` (`id`,`dateCreated`, `username`, `password`, `email`, `extensions`, `quota`, `filesize`, `active`, `last_login`, `accesslevel`, `upload_dir`, `upload_dirs`)
             VALUES ('1',now(), '".$admin_username."', '".md5($admin_password)."', '".$admin_email."', 'AVI,BMP,BSH,C,CC,CPP,CS,CSH,CSS,CV,CYC,DOC,GIF,HTM,HTML,JAVA,,JOSH,JPEG,JPG,JS,M,MOV,MP3,MP4,MXML,PDF,PERL,PHP,PL,PM,PNG,PY,RAR,RB,SH,SQL,TXT,VB,WMA,WMV,XHTML,XLS,XLSX,XML,XSL,ZIP', '10000', '10000', '1', NOW(), 'abcdefghijklmnopqrstuvwxyz', 'uploads', '1')";
