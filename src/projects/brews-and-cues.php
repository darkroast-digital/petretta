  ...
  <section class="single-project brews-and-cues">
    ...
    <div class="single-project-nav">
      ...
      <ul>
        ...
        <li><a href="/projects/cash-money.php">Next Project<i class="fa fa-caret-right"></i></a></li>
      </ul>
    </div>

    <div class="single-project-grid">
      <div class="single-project-image">
        <img src="../assets/img/projects/brews-and-cues/1.jpg" draggable="false" class="project-image">
      </div>
      <div class="single-project-image">
        <img src="../assets/img/projects/brews-and-cues/2.jpg" draggable="false" class="project-image">
      </div>
      <div class="single-project-image">
        <img src="../assets/img/projects/brews-and-cues/3.jpg" draggable="false" class="project-image">
      </div>
      <!-- End Row One -->
