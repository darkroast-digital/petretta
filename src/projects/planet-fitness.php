  ...
  <section class="single-project brews-and-cues">
    ...
    <div class="single-project-nav">
      ...
      <ul>
        ...
        <li><span>Planet Fitness</span> Bowmanville, Ontario</li>
    ...
    <div class="single-project-grid">
      <div class="single-project-image">
        <img src="../assets/img/projects/planet-fitness/1.jpg" draggable="false" class="project-image">
      </div>
      <div class="single-project-image">
        <img src="../assets/img/projects/planet-fitness/2.jpg" draggable="false" class="project-image">
      </div>
      <div class="single-project-image">
        <img src="../assets/img/projects/planet-fitness/3.jpg" draggable="false" class="project-image">
      </div>
      <div class="single-project-image">
        <img src="../assets/img/projects/planet-fitness/4.jpg" draggable="false" class="project-image">
      </div>
      <!-- End Row One -->
    </div>
  </section>
