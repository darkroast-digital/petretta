...
<div class="row">
  ...
  <section class="single-project shoppers-harrow">
    ...
    <div class="single-project-nav">
      ...
      <ul>
        <li><a href="/projects/pwc-windsor.php"><i class="fa fa-caret-left"></i>Previous Project</a></li>
        <li><span>Shopper's</span> Harrow, Ontario</li>
        <li><a href="/projects/keg-medicine-hat.php">Next Project<i class="fa fa-caret-right"></i></a></li>
      </ul>
    </div>

    <div class="single-project-grid"> 
      <div class="single-project-image">
        <img src="../assets/img/projects/shoppers-harrow/1.jpg" draggable="false" class="project-image">
      </div>
    </div>
  </section>
