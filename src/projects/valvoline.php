  ...
  <section class="single-project shoppers-harrow">
    ...
    <div class="single-project-nav">
      ...
      <ul>
        ...
        <li><a href="/projects/wfcu-dougall.php">Next Project<i class="fa fa-caret-right"></i></a></li>
      </ul>
    </div>

    <div class="single-project-grid">
      <div class="single-project-image">
        <img src="../assets/img/projects/valvoline/1.jpg" draggable="false" class="project-image">
      </div>
    </div>
  </section>
